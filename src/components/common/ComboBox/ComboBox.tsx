  ...
  return (
    <div className={cn('flex items-center justify-between text-sm', className)}>
      ...
      <div
        ...
        className={
          'flex w-1/2 cursor-pointer flex-row rounded border-none bg-gray-100 py-1 px-2 text-sm font-semibold transition-colors hover:bg-gray-200 focus-visible:bg-gray-200 focus-visible:outline-0 aria-expanded:bg-gray-200'
        }
        onClick={() => state.open()}
      >
        <input
