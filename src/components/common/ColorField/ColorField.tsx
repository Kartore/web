...
export const ColorField: FC<ColorFieldProps> = ({ className, label, ...props }) => {
  ...
  return (
    <div className={cn('flex flex-row items-center justify-between', className)}>
      ...
      <div
        className={
          'flex w-1/2 flex-row items-center gap-2 rounded border-none bg-gray-100 py-1 px-2 text-sm font-semibold transition-colors hover:bg-gray-200 focus-visible:bg-gray-200 focus-visible:outline-0'
        }
      >
        <ColorPicker
