...
export type GreaterThanInputFieldProps = {
	value: [
		'>',
...
export const GreaterThanInputField: FC<GreaterThanInputFieldProps> = ({
	className,
	children,
	value,
	onChange,
...
GreaterThanInputField.displayName = 'GreaterThanInputField';
