...
export const BoxRadioGroup: FC<BoxRadioGroupProps> = ({ className, label, items, ...props }) => {
  ...
  return (
    ...
    >
      <span {...labelProps} className={cn('font-semibold text-gray-600', labelProps.className)}>
        {label}
      </span>
