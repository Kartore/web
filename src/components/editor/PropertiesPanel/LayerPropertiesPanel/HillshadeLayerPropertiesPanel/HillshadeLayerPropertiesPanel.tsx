...
export type HillshadeLayerPropertiesPanelProps = Omit<ComponentProps<'div'>, 'onChange'> & {
  layer: HillshadeLayerSpecification;
  sources: { [key: string]: SourceSpecification };
  onChange?: onChangeType;
};

export const HillshadeLayerPropertiesPanel: FC<HillshadeLayerPropertiesPanelProps> = ({
  layer,
  sources,
  onChange,
  children,
