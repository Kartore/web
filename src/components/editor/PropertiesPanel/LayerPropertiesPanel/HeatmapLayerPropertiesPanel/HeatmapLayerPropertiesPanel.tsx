...
export type HeatmapLayerPropertiesPanelProps = Omit<
	ComponentProps<'div'>,
	'onChange'
> & {
...
export const HeatmapLayerPropertiesPanel: FC<
	...
	return (
		<div {...props} className={cn('flex flex-col gap-6', className)}>
			...
			<RawDataProperties
				layer={layer}
				onChange={onChange}
				schema={getStyleJSONSchemaDefinition('HeatmapLayerSpecification')}
			/>
			{children}
		</div>
	);
